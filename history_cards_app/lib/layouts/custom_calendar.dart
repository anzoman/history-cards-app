                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: CampAppTheme.buildLightTheme().dividerColor,
                      ),
                    ),
                    child: Material(
        ...
        Expanded(
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                  fontSize: 16, fontWeight: FontWeight.w500, color: CampAppTheme.buildLightTheme().primaryColor),
            ),
          ),
        ),
      );
                            ...
                            decoration: BoxDecoration(
                              color: startDate != null && endDate != null
                                  ? getIsItStartAndEndDate(date) || getIsInRange(date)
                                      ? CampAppTheme.buildLightTheme().primaryColor.withOpacity(0.4)
                                      : Colors.transparent
                                  : Colors.transparent,
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date)
                                  ? CampAppTheme.buildLightTheme().primaryColor
                                  : Colors.transparent,
                              borderRadius: const BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
